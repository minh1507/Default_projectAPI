...
Log4js.configure({
  appenders: { log: { type: "file", filename: __dirsource + "/logs/app1.log" } },
...
const interceptor = (req: any, res: any, next: any) => {
  ...
  if(countFileLines(__dirsource + "/logs/app1.log") == 1000)
  {
    fs.truncate(__dirsource + "/logs/app1.log", 0, function(){})
  }
